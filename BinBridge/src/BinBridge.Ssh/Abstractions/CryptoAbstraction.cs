using System;
using BinBridge.Ssh.Security.Cryptography;

namespace BinBridge.Ssh.Abstractions
{
...
#else
        public static global::BinBridge.Cryptography.MD5 CreateMD5()
        {
            return new global::BinBridge.Cryptography.MD5();
        }
...
#else
        public static global::BinBridge.Cryptography.SHA1 CreateSHA1()
        {
            return new global::BinBridge.Cryptography.SHA1();
        }
#endif
...
#else
        public static global::BinBridge.Cryptography.SHA256 CreateSHA256()
        {
            return new global::BinBridge.Cryptography.SHA256();
        }
#endif
...
#else
        public static global::BinBridge.Cryptography.SHA384 CreateSHA384()
        {
            return new global::BinBridge.Cryptography.SHA384();
        }
#endif
...
#else
        public static global::BinBridge.Cryptography.SHA512 CreateSHA512()
        {
            return new global::BinBridge.Cryptography.SHA512();
        }
#endif
...
#else
        public static global::BinBridge.Cryptography.RIPEMD160 CreateRIPEMD160()
        {
            return new global::BinBridge.Cryptography.RIPEMD160();
        }
...
#else
        public static global::BinBridge.Cryptography.HMACMD5 CreateHMACMD5(byte[] key)
        {
            return new global::BinBridge.Cryptography.HMACMD5(key);
        }

        public static global::BinBridge.Cryptography.HMACMD5 CreateHMACMD5(byte[] key, int hashSize)
        {
            return new global::BinBridge.Cryptography.HMACMD5(key, hashSize);
        }
...
#else
        public static global::BinBridge.Cryptography.HMACSHA1 CreateHMACSHA1(byte[] key)
        {
            return new global::BinBridge.Cryptography.HMACSHA1(key);
        }

        public static global::BinBridge.Cryptography.HMACSHA1 CreateHMACSHA1(byte[] key, int hashSize)
        {
            return new global::BinBridge.Cryptography.HMACSHA1(key, hashSize);
        }
...
#else
        public static global::BinBridge.Cryptography.HMACSHA256 CreateHMACSHA256(byte[] key)
        {
            return new global::BinBridge.Cryptography.HMACSHA256(key);
        }

        public static global::BinBridge.Cryptography.HMACSHA256 CreateHMACSHA256(byte[] key, int hashSize)
        {
            return new global::BinBridge.Cryptography.HMACSHA256(key, hashSize);
        }
...
#else
        public static global::BinBridge.Cryptography.HMACSHA384 CreateHMACSHA384(byte[] key)
        {
            return new global::BinBridge.Cryptography.HMACSHA384(key);
        }

        public static global::BinBridge.Cryptography.HMACSHA384 CreateHMACSHA384(byte[] key, int hashSize)
        {
            return new global::BinBridge.Cryptography.HMACSHA384(key, hashSize);
        }
...
#else
        public static global::BinBridge.Cryptography.HMACSHA512 CreateHMACSHA512(byte[] key)
        {
            return new global::BinBridge.Cryptography.HMACSHA512(key);
        }

        public static global::BinBridge.Cryptography.HMACSHA512 CreateHMACSHA512(byte[] key, int hashSize)
        {
            return new global::BinBridge.Cryptography.HMACSHA512(key, hashSize);
        }
...
#else
        public static global::BinBridge.Cryptography.HMACRIPEMD160 CreateHMACRIPEMD160(byte[] key)
        {
            return new global::BinBridge.Cryptography.HMACRIPEMD160(key);
        }
