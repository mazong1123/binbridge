...
namespace BinBridge.Ssh
{
    ...
    /// </summary>
    /// <example>
    ///     <code source="..\..\src\BinBridge.Ssh.Tests\Classes\KeyboardInteractiveConnectionInfoTest.cs" region="Example KeyboardInteractiveConnectionInfo AuthenticationPrompt" language="C#" title="Connect using interactive method" />
    /// </example>
