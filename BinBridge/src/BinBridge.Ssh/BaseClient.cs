    ...
    public abstract class BaseClient : IDisposable
    {
        ...
        public TimeSpan KeepAliveInterval
        {
            ...
            set
            {
                ...
                if (value == Ssh.Session.InfiniteTimeSpan)
                {
        ...
        /// </summary>
        /// <example>
        ///   <code source="..\..\src\BinBridge.Ssh.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect ErrorOccurred" language="C#" title="Handle ErrorOccurred event" />
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///   <code source="..\..\src\BinBridge.Ssh.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect HostKeyReceived" language="C#" title="Handle HostKeyReceived event" />
        /// </example>
        ...
        internal BaseClient(ConnectionInfo connectionInfo, bool ownsConnectionInfo, IServiceFactory serviceFactory)
        {
            ...
            _keepAliveInterval = Ssh.Session.InfiniteTimeSpan;
        }
        ...
        {
            if (_keepAliveInterval == Ssh.Session.InfiniteTimeSpan)
                return;
