...
using BinBridge.Ssh.Compression;
using BinBridge.Ssh.Messages;
...
namespace BinBridge.Ssh
{
    ...
    public class Session : ISession
    {
        ...
        internal Session(ConnectionInfo connectionInfo, IServiceFactory serviceFactory)
        {
            ...
            ClientVersion = "SSH-2.0-BinBridge.Ssh.SshClient.0.0.1";
...
#region Message loading functions
        ...
        /// <exception cref="SshOperationTimeoutException">The connection failed to establish within the configured <see cref="BinBridge.Ssh.ConnectionInfo.Timeout"/>.</exception>
