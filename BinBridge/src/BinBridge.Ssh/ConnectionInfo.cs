...
using BinBridge.Ssh.Security;
using BinBridge.Ssh.Messages.Connection;
using BinBridge.Ssh.Common;
using BinBridge.Ssh.Messages.Authentication;
using BinBridge.Ssh.Security.Cryptography.Ciphers.Modes;
using BinBridge.Ssh.Security.Cryptography.Ciphers;
...
namespace BinBridge.Ssh
{
    ...
    public class ConnectionInfo : IConnectionInfoInternal
    {
        ...
        /// </value>
        /// <example>
        ///   <code source="..\..\src\BinBridge.Ssh.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect Timeout" language="C#" title="Specify connection timeout" />
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///     <code source="..\..\src\BinBridge.Ssh.Tests\Classes\PasswordConnectionInfoTest.cs" region="Example PasswordConnectionInfo AuthenticationBanner" language="C#" title="Display authentication banner" />
        /// </example>
