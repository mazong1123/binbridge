...
using BinBridge.Ssh.Security.Cryptography.Ciphers.Paddings;
...
namespace BinBridge.Ssh
{
    ...
    /// </summary>
    /// <example>
    ///     <code source="..\..\src\BinBridge.Ssh.Tests\Data\Key.RSA.txt" language="Text" title="Private RSA key example" />
    /// </example>
    /// <remarks>
    /// <para>
